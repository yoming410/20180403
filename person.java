public class person {
    ...
    public person(String name1, String ename1, String department1, String email1, String phone1, String address1, String id1, int hight1, int weight1) {
        this.setName(name1);
